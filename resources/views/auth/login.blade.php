                ...
                <div class="row justify-content-center no-gutters vertical-align">
                    ...
                    <div class="col-lg-4 col-md-6 bg-white">
                        <div class="login-fancy pb-40 clearfix">
                            ...
                            @elseif($type == 'parent')
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Login Parents </h3>
                            @elseif($type == 'teacher')
                            <h3 style="font-family: 'Cairo', sans-serif" class="mb-30">Login Teachers </h3>
                            @else
                            ...
                            <form method="POST" action="{{route('login')}}">
                                ...
                                <div class="section-field mb-20">
                                    <label class="mb-10" for="name">Email Adress*</label>
